这个项目是用于演示如何用argo-events、tekton、vault实现一个代码提交即触发的流水线，基础环境的配置和部署方法可以参考[这个项目](https://github.com/walk1ng/demo-vcluster-tekton-argoevents-vaultagent-externalsecrets)。
